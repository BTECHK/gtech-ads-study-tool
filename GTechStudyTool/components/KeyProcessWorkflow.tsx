...
import { X, ChevronRight, Globe, Server, Shield, Database, Code, Zap, Clock, CheckCircle2, AlertTriangle, Info, ArrowRight, GripHorizontal, Minimize2, Maximize2 } from 'lucide-react';
...
const processWorkflows: Record<string, {
  ...
  'bidding-systems': {
    title: 'Bidding Strategies & AI/ML',
    subtitle: 'From manual control to AI-driven optimization',
    steps: [
      {
        id: 'charging',
        ...
        icon: Database,
        color: 'from-blue-500 to-indigo-500',
        description: 'How advertisers pay for ads',
        considerations: [
          { title: 'CPC', type: 'info', content: 'Cost Per Click - pay only when user clicks. Best for direct response.' },
          { title: 'CPM', type: 'info', content: 'Cost Per Mille (1000 impressions) - pay for eyeballs. Best for brand awareness.' },
          { title: 'CPV/CPA', type: 'info', content: 'CPV = video views. CPA = per acquisition. Align cost with business goal.' },
        ],
      },
      {
        id: 'manual',
        ...
        icon: Code,
        color: 'from-green-500 to-emerald-500',
        description: 'Full control over max bids',
        considerations: [
          { title: 'Manual CPC', type: 'info', content: 'Set max bid per keyword. Full control, requires active management.' },
          { title: 'Enhanced CPC', type: 'success', content: 'Manual base + ML adjustment. Google can raise/lower based on conversion likelihood.' },
          { title: 'Trade-off', type: 'warning', content: 'More control = more work. Good for testing, learning, or small budgets.' },
        ],
      },
      {
        id: 'automated',
        ...
        icon: Zap,
        color: 'from-purple-500 to-pink-500',
        description: 'Let Google optimize bids',
        considerations: [
          { title: 'Target CPA', type: 'success', content: 'Set target cost per conversion. Google adjusts bids to hit target.' },
          { title: 'Target ROAS', type: 'success', content: 'Set target return on ad spend. Best for e-commerce with varied values.' },
          { title: 'Maximize Conv', type: 'info', content: 'Spend full budget getting most conversions. No efficiency target.' },
        ],
      },
      {
        id: 'ai-evolution',
        title: 'AI/ML Evolution',
        icon: Globe,
        color: 'from-orange-500 to-amber-500',
        description: 'How Smart Bidding learns',
        considerations: [
          { title: 'Signal Processing', type: 'success', content: 'ML considers 100+ signals: device, location, time, demographics, remarketing lists.' },
          { title: 'Broad Match + Smart', type: 'success', content: 'Broad match now viable. ML finds high-intent queries you never thought to target.' },
          { title: 'Learning Period', type: 'warning', content: '~2 weeks to gather data. Don\'t judge too early. Need 30+ conversions for confidence.' },
        ],
      },
    ],
  },
  'campaign-types': {
    ...
    subtitle: 'Match the right campaign type to your goal',
    steps: [
      {
        id: 'search',
        ...
        icon: Globe,
        color: 'from-blue-500 to-cyan-500',
        description: 'Text ads on Google Search',
        considerations: [
          { title: 'Intent-Based', type: 'success', content: 'User actively searching = highest intent. Best for conversions.' },
          { title: 'Keyword Targeting', type: 'info', content: 'Exact, Phrase, Broad match types control which queries trigger ads.' },
          { title: 'RSA', type: 'info', content: 'Responsive Search Ads - provide 15 headlines, 4 descriptions. Google tests combinations.' },
        ],
      },
      {
        id: 'display',
        ...
        icon: Code,
        color: 'from-green-500 to-emerald-500',
        description: 'Visual ads across 3M+ sites',
        considerations: [
          { title: 'Awareness', type: 'info', content: 'Lower intent but massive reach. Good for brand building, remarketing.' },
          { title: 'Targeting', type: 'info', content: 'Audience segments, topics, placements, keywords (contextual).' },
          { title: 'Responsive Display', type: 'success', content: 'Upload assets, Google auto-creates ads for any placement size.' },
        ],
      },
      {
        id: 'video',
        ...
        considerations: [
          { title: 'TrueView In-Stream', type: 'info', content: 'Skippable after 5s. Pay only if watched 30s or clicked.' },
          { title: 'Bumper Ads', type: 'info', content: '6-second non-skippable. Great for brand recall at scale.' },
          { title: 'Video Action', type: 'success', content: 'Optimized for conversions. CTA buttons, site links on video.' },
        ],
      },
      {
        id: 'shopping',
        ...
        icon: Database,
        color: 'from-purple-500 to-violet-500',
        description: 'Product listings with images/prices',
        considerations: [
          { title: 'Product Feed', type: 'warning', content: 'Requires Merchant Center setup. Feed quality = ad quality.' },
          { title: 'No Keywords', type: 'info', content: 'Google matches products to queries using feed data.' },
          { title: 'High Intent', type: 'success', content: 'Users see price/image before clicking. Qualified traffic.' },
        ],
      },
      {
        id: 'pmax',
        ...
        icon: CheckCircle2,
        color: 'from-orange-500 to-amber-500',
        description: 'AI-driven, all Google inventory',
        considerations: [
          { title: 'Full Funnel', type: 'success', content: 'One campaign across Search, Display, YouTube, Discover, Gmail, Maps.' },
          { title: 'Goal-Based', type: 'info', content: 'Set conversion goal, budget, assets. Google handles targeting/bidding/creative.' },
          { title: 'Black Box', type: 'warning', content: 'Less transparency. Use Asset Groups for some control. Monitor with Insights tab.' },
        ],
      },
    ],
  },
  'ads-lifecycle': {
    title: 'End-to-End Ads Lifecycle',
    subtitle: 'The complete advertiser journey from goal to optimization',
    steps: [
      {
        id: 'goals',
        title: 'Define Goals',
        ...
        considerations: [
          { title: 'Business Objectives', type: 'info', content: 'Sales, leads, website traffic, app installs, brand awareness, store visits.' },
          { title: 'SMART Goals', type: 'success', content: 'Specific, Measurable, Achievable, Relevant, Time-bound. "100 leads at $50 CPA in Q1."' },
          { title: 'KPIs', type: 'info', content: 'Define primary KPI (conversions) and secondary (CTR, impression share).' },
        ],
      },
      {
        id: 'campaign-choice',
        ...
        icon: Zap,
        color: 'from-green-500 to-emerald-500',
        description: 'Match format to objective',
        considerations: [
          { title: 'Search for Intent', type: 'success', content: 'User actively searching = Search campaigns. Highest conversion rates.' },
          { title: 'Display for Awareness', type: 'info', content: 'Building brand, remarketing = Display. Lower intent, higher reach.' },
          { title: 'PMax for Automation', type: 'info', content: 'Let Google optimize across all surfaces. Good for mature accounts.' },
        ],
      },
      {
        id: 'targeting',
        ...
        icon: Database,
        color: 'from-purple-500 to-pink-500',
        description: 'Who sees your ads?',
        considerations: [
          { title: 'Keywords', type: 'info', content: 'Match types: Exact [shoes], Phrase "running shoes", Broad running shoes.' },
          { title: 'Audiences', type: 'info', content: 'In-market, affinity, custom segments, remarketing lists, Customer Match.' },
          { title: 'Negative Targeting', type: 'warning', content: 'Exclude irrelevant queries/audiences. Reduces wasted spend.' },
        ],
      },
      {
        id: 'bidding-budget',
        ...
        icon: Code,
        color: 'from-orange-500 to-amber-500',
        description: 'How much and how to spend',
        considerations: [
          { title: 'Budget Allocation', type: 'info', content: 'Daily budget × 30.4 = monthly spend cap. Can exceed daily by 2x.' },
          { title: 'Bidding Strategy', type: 'success', content: 'Start manual/maximize clicks to learn, then Target CPA/ROAS for efficiency.' },
          { title: 'Bid Adjustments', type: 'info', content: 'Device, location, time of day, audience. Layer on top of base bid.' },
        ],
      },
      {
        id: 'measure-optimize',
        ...
        considerations: [
          { title: 'Conversion Tracking', type: 'warning', content: 'gtag.js or GTM. No tracking = flying blind. Set up BEFORE launching.' },
          { title: 'GA4 Integration', type: 'success', content: 'Link accounts for richer audience data, cross-device insights.' },
          { title: 'Optimization Loop', type: 'success', content: 'Weekly: review search terms, adjust bids, test ad copy. Monthly: strategy review.' },
        ],
      },
    ],
  },
...
export function KeyProcessWorkflow() {
  ...
  const displayHeight = isMinimized ? 56 : panelHeight;

  return (
    <div
      className="fixed bottom-0 left-0 right-0 bg-white border-t-4 border-blue-500 shadow-[0_-8px_30px_-10px_rgba(0,0,0,0.3)] z-40 animate-in slide-in-from-bottom duration-300 flex flex-col"
      style={{ height: displayHeight, marginBottom: 0 }}
    >
      {/* Resize handle */}
      {!isMinimized && (
        <div
          className={cn(
            "absolute -top-3 left-1/2 -translate-x-1/2 w-24 h-6 cursor-ns-resize flex items-center justify-center rounded-t-lg bg-blue-500 hover:bg-blue-600 transition-colors",
      ...
      {/* Header */}
      <div className="flex items-center justify-between px-6 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 shrink-0">
      ...
      {!isMinimized && (
        <div className="flex-1 px-6 py-4 overflow-x-auto overflow-y-auto bg-gradient-to-b from-white to-gray-50">
